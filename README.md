...
**Nếu bạn là self-hosting, bạn cần chú ý các file được cập nhật. Nếu bạn sử dụng Mining Proxy, bạn không cần phải làm gì cả:**
```
maxmines.min.js (Version: 2224250921, salt: 4wYtJY1EC8uyIk5x)
cachedmine.min.js (Version: 2216250921, salt: Jj1k62gqOvcvTnoG)
```
## Bảo trì sự cố và cập nhật máy chủ (ngày 24/09/2021)
**Nếu bạn là self-hosting, bạn cần chú ý các file được cập nhật. Nếu bạn sử dụng Mining Proxy, bạn không cần phải làm gì cả:**
```
maxmines.min.js (Version: 1908240921, salt: kbMEofwECFUm35fc)
cachedmine.min.js (Version: 1911240921, salt: BIHPP8CgGkTTSKjM)
```
...
| Số phía sau tên nhân viên ra bài |           Mô tả          |
| -------------------------------- | ------------------------ |  
|                256               |    Nhân viên quan trọng  |  
|                512               |    Nhân viên xuất sắc    |  
|                1024              |      Nhân viên giỏi      |  
|                2048              |  Nhân viên ít quan trọng |
...
- Fix bug captcha Web app không load
...
- Cập nhật trang tải app MaxMines mới (2 app).
## MaxMines Proxies apk (ngày 07/09/2020)
- Hoàn thành beta MaxMines Proxies apk
